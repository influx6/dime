...
//go:generate moz generate-file -fromFile ./float64_slice_service.go -toDir ./impl/float64sliceservice

// Float64SliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of float64.
type Float64SliceServiceByteAdapter func(chan []byte) chan float64

// Float64SliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of float64.
type Float64SliceServiceToByteAdapter func(chan float64) chan []byte
