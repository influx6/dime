...
//go:generate moz generate-file -fromFile ./error_service.go -toDir ./impl/errorservice

// ErrorServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of error.
type ErrorServiceByteAdapter func(chan []byte) chan error

// ErrorServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of error.
type ErrorServiceToByteAdapter func(chan error) chan []byte
