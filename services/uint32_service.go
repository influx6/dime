...
//go:generate moz generate-file -fromFile ./uint32_service.go -toDir ./impl/uint32service

// UInt32ServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of uint32.
type UInt32ServiceByteAdapter func(chan []byte) chan uint32

// UInt32ServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of uint32.
type UInt32ServiceToByteAdapter func(chan uint32) chan []byte
