...
// NewUInt32Disributor returns a new instance of a UInt32Distributor.
func NewUInt32Disributor(buffer int, sendWaitBeforeAbort time.Duration) *UInt32Distributor {
