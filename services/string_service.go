...
//go:generate moz generate-file -fromFile ./string_service.go -toDir ./impl/stringservice

// StringServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of string.
type StringServiceByteAdapter func(chan []byte) chan string

// StringServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of string.
type StringServiceToByteAdapter func(chan string) chan []byte
