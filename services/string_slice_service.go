...
//go:generate moz generate-file -fromFile ./string_slice_service.go -toDir ./impl/stringsliceservice

// StringSliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []string.
type StringSliceServiceByteAdapter func(chan []byte) chan []string

// StringSliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []string.
type StringSliceServiceToByteAdapter func(chan []string) chan []byte
