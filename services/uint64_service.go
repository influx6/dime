...
type UInt64FromByteAdapterWithContext func(CancelContext, chan []byte) chan uint64
...
// NewUInt64Disributor returns a new instance of a UInt64Distributor.
func NewUInt64Disributor(buffer int, sendWaitBeforeAbort time.Duration) *UInt64Distributor {
