...
//go:generate moz generate-file -fromFile ./complex128_slice_service.go -toDir ./impl/complex128sliceservice

// Complex128SliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of complex128.
type Complex128SliceServiceByteAdapter func(chan []byte) chan complex128

// Complex128SliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of complex128.
type Complex128SliceServiceToByteAdapter func(chan complex128) chan []byte
