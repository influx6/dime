...
//go:generate moz generate-file -fromFile ./uint64_slice_service.go -toDir ./impl/uint64sliceservice

// UInt64SliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []uint64.
type UInt64SliceServiceByteAdapter func(chan []byte) chan []uint64

// UInt64SliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []uint64.
type UInt64SliceServiceToByteAdapter func(chan []uint64) chan []byte
