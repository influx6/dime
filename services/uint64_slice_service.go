...
type UInt64SliceFromByteAdapterWithContext func(CancelContext, chan []byte) chan []uint64
...
// NewUInt64SliceDisributor returns a new instance of a UInt64SliceDistributor.
func NewUInt64SliceDisributor(buffer int, sendWaitBeforeAbort time.Duration) *UInt64SliceDistributor {
...
func (d *UInt64SliceDistributor) Start() {
	if atomic.LoadInt64(&d.running) != 0 {
		return
	}
