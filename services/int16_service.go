...
//go:generate moz generate-file -fromFile ./int16_service.go -toDir ./impl/int16service

// Int16ServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of int16.
type Int16ServiceByteAdapter func(chan []byte) chan int16

// Int16ServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of int16.
type Int16ServiceToByteAdapter func(chan int16) chan []byte
