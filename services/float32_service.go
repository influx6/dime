...
//go:generate moz generate-file -fromFile ./float32_service.go -toDir ./impl/float32service

// Float32ServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of float32.
type Float32ServiceByteAdapter func(chan []byte) chan float32

// Float32ServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of float32.
type Float32ServiceToByteAdapter func(chan float32) chan []byte
