...
//go:generate moz generate-file -fromFile ./complex128_service.go -toDir ./impl/complex128service

// Complex128ServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of complex128.
type Complex128ServiceByteAdapter func(chan []byte) chan complex128

// Complex128ServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of complex128.
type Complex128ServiceToByteAdapter func(chan complex128) chan []byte
