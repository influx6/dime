...
// method.
func Complex128Sink(ctx CancelContext, waitTime time.Duration, in chan<- complex128) chan<- complex128 {
	res := make(chan complex128, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Complex128SinkFilter(ctx CancelContext, waitTime time.Duration, filterFn func(complex128) bool, in chan<- complex128) chan<- complex128 {
	res := make(chan complex128, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Complex128SinkMutate(ctx CancelContext, waitTime time.Duration, mutateFn func(complex128) complex128, in chan<- complex128) chan<- complex128 {
	res := make(chan complex128, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Complex128SinkView(ctx CancelContext, waitTime time.Duration, viewFn func(complex128), in chan<- complex128) chan<- complex128 {
	res := make(chan complex128, 0)
