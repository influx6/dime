...
// MapOfAnyDataWriterFunc defines a function type which recieves a value to be written and returns true/false
// if the operation succeeded.
type MapOfAnyDataWriterFunc func(map[interface{}]interface{}) bool
...
type MapOfAnyFromByteAdapter func(CancelContext, <-chan []byte) <-chan map[interface{}]interface{}
...
// MapOfAnyView defines a function which returns a channel where the items of the incoming channel
...
// If the given channel is closed or if the context expires, the returning channel is closed as well.
// This function guarantees complete data.
func MapOfAnyView(ctx CancelContext, waitTime time.Duration, viewFn func(map[interface{}]interface{}), in <-chan map[interface{}]interface{}) <-chan map[interface{}]interface{} {
	res := make(chan map[interface{}]interface{}, 0)
...
// MapOfAnySink defines a function which returns a channel, where the items of the returned channel
...
// method.
func MapOfAnySink(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, in chan<- map[interface{}]interface{}) chan<- map[interface{}]interface{} {
	res := make(chan map[interface{}]interface{}, 0)
...
// MapOfAnyWriterFuncToWithin defines a function which recieves a CancelContext, max time.Duration and write channel,
...
func MapOfAnyWriterFuncToWithin(ctx CancelContext, acceptanceMaxWait time.Duration, in chan<- map[interface{}]interface{}) MapOfAnyDataWriterFunc {
...
// MapOfAnyWriterFuncTo defines a function which recieves a CancelContext and write channel, to
...
// The returned function returns true/false to signal success write of value.
func MapOfAnyWriterFuncTo(ctx CancelContext, in chan<- map[interface{}]interface{}) MapOfAnyDataWriterFunc {
	return func(val map[interface{}]interface{}) bool {
		select {
		case <-ctx.Done():
			return false
...
// MapOfAnySinkFilter defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func MapOfAnySinkFilter(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, filterFn func(map[interface{}]interface{}) bool, in chan<- map[interface{}]interface{}) chan<- map[interface{}]interface{} {
	res := make(chan map[interface{}]interface{}, 0)
...
// MapOfAnySinkMutate defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func MapOfAnySinkMutate(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, mutateFn func(map[interface{}]interface{}) map[interface{}]interface{}, in chan<- map[interface{}]interface{}) chan<- map[interface{}]interface{} {
	res := make(chan map[interface{}]interface{}, 0)
...
// MapOfAnySinkView defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func MapOfAnySinkView(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, viewFn func(map[interface{}]interface{}), in chan<- map[interface{}]interface{}) chan<- map[interface{}]interface{} {
	res := make(chan map[interface{}]interface{}, 0)
...
// NewMapOfAnyDistributor returns a new instance of a MapOfAnyDistributor.
func NewMapOfAnyDistributor(buffer int, sendWaitBeforeAbort time.Duration) *MapOfAnyDistributor {
	if sendWaitBeforeAbort <= 0 {
		sendWaitBeforeAbort = defaultSendWithBeforeAbort
	}

	dist := &MapOfAnyDistributor{
