...
//go:generate moz generate-file -fromFile ./map_of_any_service.go -toDir ./impl/mapofanyservice

// MapOfAnyServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of map[interface{}]interface{}.
type MapOfAnyServiceByteAdapter func(chan []byte) chan map[interface{}]interface{}

// MapOfAnyServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of map[interface{}]interface{}.
type MapOfAnyServiceToByteAdapter func(chan map[interface{}]interface{}) chan []byte
