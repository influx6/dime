...
// NewFloat32SliceDisributor returns a new instance of a Float32SliceDistributor.
func NewFloat32SliceDisributor(buffer int, sendWaitBeforeAbort time.Duration) *Float32SliceDistributor {
