...
// Int32DataWriterFunc defines a function type which recieves a value to be written and returns true/false
// if the operation succeeded.
type Int32DataWriterFunc func(int32) bool
...
// Int32Sink defines a function which returns a channel, where the items of the returned channel
...
// method.
func Int32Sink(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, in chan<- int32) chan<- int32 {
	res := make(chan int32, 0)
...
// Int32WriterFuncToWithin defines a function which recieves a CancelContext, max time.Duration and write channel,
...
func Int32WriterFuncToWithin(ctx CancelContext, acceptanceMaxWait time.Duration, in chan<- int32) Int32DataWriterFunc {
...
// Int32WriterFuncTo defines a function which recieves a CancelContext and write channel, to
...
// The returned function returns true/false to signal success write of value.
func Int32WriterFuncTo(ctx CancelContext, in chan<- int32) Int32DataWriterFunc {
	return func(val int32) bool {
		select {
		case <-ctx.Done():
			return false
...
// Int32SinkFilter defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SinkFilter(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, filterFn func(int32) bool, in chan<- int32) chan<- int32 {
	res := make(chan int32, 0)
...
// Int32SinkMutate defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SinkMutate(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, mutateFn func(int32) int32, in chan<- int32) chan<- int32 {
	res := make(chan int32, 0)
...
// Int32SinkView defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SinkView(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, viewFn func(int32), in chan<- int32) chan<- int32 {
	res := make(chan int32, 0)
...
func NewInt32Distributor(buffer int) *Int32Distributor {
	dist := &Int32Distributor{
