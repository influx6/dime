...
// method.
func Int32Sink(ctx CancelContext, waitTime time.Duration, in chan<- int32) chan<- int32 {
	res := make(chan int32, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SinkFilter(ctx CancelContext, waitTime time.Duration, filterFn func(int32) bool, in chan<- int32) chan<- int32 {
	res := make(chan int32, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SinkMutate(ctx CancelContext, waitTime time.Duration, mutateFn func(int32) int32, in chan<- int32) chan<- int32 {
	res := make(chan int32, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SinkView(ctx CancelContext, waitTime time.Duration, viewFn func(int32), in chan<- int32) chan<- int32 {
	res := make(chan int32, 0)
