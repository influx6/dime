...
//go:generate moz generate-file -fromFile ./bool_slice_service.go -toDir ./impl/boolsliceservice

// BoolSliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []bool.
type BoolSliceServiceByteAdapter func(chan []byte) chan []bool

// BoolSliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []bool.
type BoolSliceServiceToByteAdapter func(chan []bool) chan []byte
