...
//go:generate moz generate-file -fromFile ./int64_slice_service.go -toDir ./impl/int64sliceservice

// Int64SliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []int64.
type Int64SliceServiceByteAdapter func(chan []byte) chan []int64

// Int64SliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []int64.
type Int64SliceServiceToByteAdapter func(chan []int64) chan []byte
