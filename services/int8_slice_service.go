...
// NewInt8SliceDisributor returns a new instance of a Int8SliceDistributor.
func NewInt8SliceDisributor(buffer int, sendWaitBeforeAbort time.Duration) *Int8SliceDistributor {
