...
//go:generate moz generate-file -fromFile ./complex64_service.go -toDir ./impl/complex64service

// Complex64ServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of complex64.
type Complex64ServiceByteAdapter func(chan []byte) chan complex64

// Complex64ServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of complex64.
type Complex64ServiceToByteAdapter func(chan complex64) chan []byte
