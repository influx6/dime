...
//go:generate moz generate-file -fromFile ./map_service.go -toDir ./impl/mapservice

// MapServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of map[string]string.
type MapServiceByteAdapter func(chan []byte) chan map[string]string

// MapServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of map[string]string.
type MapServiceToByteAdapter func(chan map[string]string) chan []byte
