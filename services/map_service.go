...
// method.
func MapSink(ctx CancelContext, waitTime time.Duration, in chan<- map[string]string) chan<- map[string]string {
	res := make(chan map[string]string, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func MapSinkFilter(ctx CancelContext, waitTime time.Duration, filterFn func(map[string]string) bool, in chan<- map[string]string) chan<- map[string]string {
	res := make(chan map[string]string, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func MapSinkMutate(ctx CancelContext, waitTime time.Duration, mutateFn func(map[string]string) map[string]string, in chan<- map[string]string) chan<- map[string]string {
	res := make(chan map[string]string, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func MapSinkView(ctx CancelContext, waitTime time.Duration, viewFn func(map[string]string), in chan<- map[string]string) chan<- map[string]string {
	res := make(chan map[string]string, 0)
