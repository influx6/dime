...
//go:generate moz generate-file -fromFile ./uint32_slice_service.go -toDir ./impl/uint32sliceservice

// UInt32SliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []uint32.
type UInt32SliceServiceByteAdapter func(chan []byte) chan []uint32

// UInt32SliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []uint32.
type UInt32SliceServiceToByteAdapter func(chan []uint32) chan []byte
