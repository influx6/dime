...
// method.
func UInt32SliceSink(ctx CancelContext, waitTime time.Duration, in chan<- []uint32) chan<- []uint32 {
	res := make(chan []uint32, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func UInt32SliceSinkFilter(ctx CancelContext, waitTime time.Duration, filterFn func([]uint32) bool, in chan<- []uint32) chan<- []uint32 {
	res := make(chan []uint32, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func UInt32SliceSinkMutate(ctx CancelContext, waitTime time.Duration, mutateFn func([]uint32) []uint32, in chan<- []uint32) chan<- []uint32 {
	res := make(chan []uint32, 0)
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func UInt32SliceSinkView(ctx CancelContext, waitTime time.Duration, viewFn func([]uint32), in chan<- []uint32) chan<- []uint32 {
	res := make(chan []uint32, 0)
