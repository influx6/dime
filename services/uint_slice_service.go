...
//go:generate moz generate-file -fromFile ./uint_slice_service.go -toDir ./impl/uintsliceservice

// UIntSliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []uint.
type UIntSliceServiceByteAdapter func(chan []byte) chan []uint

// UIntSliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []uint.
type UIntSliceServiceToByteAdapter func(chan []uint) chan []byte
