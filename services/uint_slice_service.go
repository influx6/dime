...
type UIntSliceFromByteAdapterWithContext func(CancelContext, chan []byte) chan []uint
...
// NewUIntSliceDisributor returns a new instance of a UIntSliceDistributor.
func NewUIntSliceDisributor(buffer int, sendWaitBeforeAbort time.Duration) *UIntSliceDistributor {
