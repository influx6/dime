...
//go:generate moz generate-file -fromFile ./map_of_any_slice_service.go -toDir ./impl/mapofanysliceservice

// MapOfAnySliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []map[interface{}]interface{}.
type MapOfAnySliceServiceByteAdapter func(chan []byte) chan []map[interface{}]interface{}

// MapOfAnySliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []map[interface{}]interface{}.
type MapOfAnySliceServiceToByteAdapter func(chan []map[interface{}]interface{}) chan []byte
