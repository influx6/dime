...
type Int8FromByteAdapterWithContext func(CancelContext, chan []byte) chan int8
...
// NewInt8Disributor returns a new instance of a Int8Distributor.
func NewInt8Disributor(buffer int, sendWaitBeforeAbort time.Duration) *Int8Distributor {
