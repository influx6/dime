...
type UInt8SliceFromByteAdapterWithContext func(CancelContext, chan []byte) chan []uint8
...
// NewUInt8SliceDisributor returns a new instance of a UInt8SliceDistributor.
func NewUInt8SliceDisributor(buffer int, sendWaitBeforeAbort time.Duration) *UInt8SliceDistributor {
