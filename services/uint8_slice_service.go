...
type UInt8SliceFromByteAdapterWithContext func(context.Context, chan []byte) chan []uint8

// UInt8SliceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []uint8.
type UInt8SliceToByteAdapter func(context.Context, chan []uint8) chan []byte
...
func UInt8SlicePartialCollect(ctx context.Context, waitTime time.Duration, in chan []uint8) chan [][]uint8 {
...
func UInt8SliceCollect(ctx context.Context, waitTime time.Duration, in chan []uint8) chan [][]uint8 {
	res := make(chan [][]uint8, 0)
...
// This function guarantees complete data.
func UInt8SliceMutate(ctx context.Context, waitTime time.Duration, mutateFn func([]uint8) []uint8, in chan []uint8) chan []uint8 {
	res := make(chan []uint8, 0)
...
// If the given channel is closed or if the context expires, the returning channel is closed as well.
// This function guarantees complete data.
func UInt8SliceFilter(ctx context.Context, waitTime time.Duration, filterFn func([]uint8) bool, in chan []uint8) chan []uint8 {
	res := make(chan []uint8, 0)
...
func UInt8SliceCollectUntil(ctx context.Context, waitTime time.Duration, condition func([][]uint8) bool, in chan []uint8) chan [][]uint8 {
	res := make(chan [][]uint8, 0)
...
func UInt8SliceMergeWithoutOrder(ctx context.Context, maxWaitTime time.Duration, senders ...chan []uint8) chan []uint8 {
	res := make(chan []uint8, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func UInt8SliceMergeInOrder(ctx context.Context, maxWaitTime time.Duration, senders ...chan []uint8) chan []uint8 {
	res := make(chan []uint8, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func UInt8SliceCombinePartiallyWithoutOrder(ctx context.Context, maxItemWait time.Duration, senders ...chan []uint8) chan [][]uint8 {
	res := make(chan [][]uint8, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func UInt8SliceCombineWithoutOrder(ctx context.Context, maxItemWait time.Duration, senders ...chan []uint8) chan [][]uint8 {
	res := make(chan [][]uint8, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func UInt8SliceCombineInPartialOrder(ctx context.Context, maxItemWait time.Duration, senders ...chan []uint8) chan [][]uint8 {
	res := make(chan [][]uint8, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func UInt8SliceCombineInOrder(ctx context.Context, maxItemWait time.Duration, senders ...chan []uint8) chan [][]uint8 {
	res := make(chan [][]uint8, 0)
