...
//go:generate moz generate-file -fromFile ./int64_service.go -toDir ./impl/int64service

// Int64ServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of int64.
type Int64ServiceByteAdapter func(chan []byte) chan int64

// Int64ServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of int64.
type Int64ServiceToByteAdapter func(chan int64) chan []byte
