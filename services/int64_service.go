...
type Int64FromByteAdapterWithContext func(CancelContext, chan []byte) chan int64
...
// NewInt64Disributor returns a new instance of a Int64Distributor.
func NewInt64Disributor(buffer int, sendWaitBeforeAbort time.Duration) *Int64Distributor {
