...
type Int32SliceFromByteAdapterWithContext func(context.Context, chan []byte) chan []int32

// Int32SliceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []int32.
type Int32SliceToByteAdapter func(context.Context, chan []int32) chan []byte
...
func Int32SlicePartialCollect(ctx context.Context, waitTime time.Duration, in chan []int32) chan [][]int32 {
...
func Int32SliceCollect(ctx context.Context, waitTime time.Duration, in chan []int32) chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// This function guarantees complete data.
func Int32SliceMutate(ctx context.Context, waitTime time.Duration, mutateFn func([]int32) []int32, in chan []int32) chan []int32 {
	res := make(chan []int32, 0)
...
// If the given channel is closed or if the context expires, the returning channel is closed as well.
// This function guarantees complete data.
func Int32SliceFilter(ctx context.Context, waitTime time.Duration, filterFn func([]int32) bool, in chan []int32) chan []int32 {
	res := make(chan []int32, 0)
...
func Int32SliceCollectUntil(ctx context.Context, waitTime time.Duration, condition func([][]int32) bool, in chan []int32) chan [][]int32 {
	res := make(chan [][]int32, 0)
...
func Int32SliceMergeWithoutOrder(ctx context.Context, maxWaitTime time.Duration, senders ...chan []int32) chan []int32 {
	res := make(chan []int32, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceMergeInOrder(ctx context.Context, maxWaitTime time.Duration, senders ...chan []int32) chan []int32 {
	res := make(chan []int32, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceCombinePartiallyWithoutOrder(ctx context.Context, maxItemWait time.Duration, senders ...chan []int32) chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceCombineWithoutOrder(ctx context.Context, maxItemWait time.Duration, senders ...chan []int32) chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceCombineInPartialOrder(ctx context.Context, maxItemWait time.Duration, senders ...chan []int32) chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceCombineInOrder(ctx context.Context, maxItemWait time.Duration, senders ...chan []int32) chan [][]int32 {
	res := make(chan [][]int32, 0)
