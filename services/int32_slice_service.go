...
//go:generate moz generate-file -fromFile ./int32_slice_service.go -toDir ./impl/int32sliceservice

// Int32SliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []int32.
type Int32SliceServiceByteAdapter func(chan []byte) chan []int32

// Int32SliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []int32.
type Int32SliceServiceToByteAdapter func(chan []int32) chan []byte
