...
type Int32SliceFromByteAdapterWithContext func(CancelContext, chan []byte) chan []int32
...
// NewInt32SliceDisributor returns a new instance of a Int32SliceDistributor.
func NewInt32SliceDisributor(buffer int, sendWaitBeforeAbort time.Duration) *Int32SliceDistributor {
