...
//go:generate moz generate-file -fromFile ./int32_slice_service.go -toDir ./impl/int32slice

// Int32SliceDataWriterFunc defines a function type which recieves a value to be written and returns true/false
// if the operation succeeded.
type Int32SliceDataWriterFunc func([]int32) bool

// Int32SliceFromByteAdapter defines a function that that will take a channel of bytes and return a channel of []int32.
type Int32SliceFromByteAdapter func(CancelContext, <-chan []byte) <-chan []int32

// Int32SliceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []int32.
type Int32SliceToByteAdapter func(CancelContext, <-chan []int32) <-chan []byte

// Int32SlicePartialCollect defines a function which returns a channel where the items of the incoming channel
...
func Int32SlicePartialCollect(ctx CancelContext, waitTime time.Duration, in <-chan []int32) <-chan [][]int32 {
...
// Int32SliceCollect defines a function which returns a channel where the items of the incoming channel
...
func Int32SliceCollect(ctx CancelContext, waitTime time.Duration, in <-chan []int32) <-chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// Int32SliceMutate defines a function which returns a channel where the items of the incoming channel
...
// This function guarantees complete data.
func Int32SliceMutate(ctx CancelContext, waitTime time.Duration, mutateFn func([]int32) []int32, in <-chan []int32) <-chan []int32 {
	res := make(chan []int32, 0)
...
// Int32SliceView defines a function which returns a channel where the items of the incoming channel
...
// If the given channel is closed or if the context expires, the returning channel is closed as well.
// This function guarantees complete data.
func Int32SliceView(ctx CancelContext, waitTime time.Duration, viewFn func([]int32), in <-chan []int32) <-chan []int32 {
	res := make(chan []int32, 0)
...
// Int32SliceSink defines a function which returns a channel, where the items of the returned channel
...
// method.
func Int32SliceSink(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, in chan<- []int32) chan<- []int32 {
	res := make(chan []int32, 0)
...
// Int32SliceWriterFuncToWithin defines a function which recieves a CancelContext, max time.Duration and write channel,
...
func Int32SliceWriterFuncToWithin(ctx CancelContext, acceptanceMaxWait time.Duration, in chan<- []int32) Int32SliceDataWriterFunc {
	return func(val []int32) bool {
		select {
		case <-ctx.Done():
			return false
		case in <- val:
...
// Int32SliceWriterFuncTo defines a function which recieves a CancelContext and write channel, to
...
// The returned function returns true/false to signal success write of value.
func Int32SliceWriterFuncTo(ctx CancelContext, in chan<- []int32) Int32SliceDataWriterFunc {
	return func(val []int32) bool {
		select {
		case <-ctx.Done():
			return false
...
// Int32SliceSinkFilter defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SliceSinkFilter(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, filterFn func([]int32) bool, in chan<- []int32) chan<- []int32 {
	res := make(chan []int32, 0)
...
// Int32SliceSinkMutate defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SliceSinkMutate(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, mutateFn func([]int32) []int32, in chan<- []int32) chan<- []int32 {
	res := make(chan []int32, 0)
...
// Int32SliceSinkView defines a function which returns a channel where the items of the returned channel
...
// sends data into the returned channel to ensure that it is closed and stopped once context has expired by it's Done()
// method.
func Int32SliceSinkView(ctx CancelContext, closeInputAlso bool, waitTime time.Duration, viewFn func([]int32), in chan<- []int32) chan<- []int32 {
	res := make(chan []int32, 0)
...
// Int32SliceFilter defines a function which returns a channel where the items of the incoming channel
// are filtered based on a function, till the provided channel is closed.
// If the given channel is closed or if the context expires, the returning channel is closed as well.
// This function guarantees complete data.
func Int32SliceFilter(ctx CancelContext, waitTime time.Duration, filterFn func([]int32) bool, in <-chan []int32) <-chan []int32 {
	res := make(chan []int32, 0)
...
// Int32SliceCollectUntil defines a function which returns a channel where the items of the incoming channel
...
func Int32SliceCollectUntil(ctx CancelContext, waitTime time.Duration, condition func([][]int32) bool, in <-chan []int32) <-chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// Int32SliceMergeWithoutOrder merges the incoming data from the []int32 into a single stream of []int32,
...
func Int32SliceMergeWithoutOrder(ctx CancelContext, maxWaitTime time.Duration, senders ...<-chan []int32) <-chan []int32 {
	res := make(chan []int32, 0)
	...
	go func() {
		...
		filledContent := make(map[int][]int32, 0)
...
// Int32SliceMergeInOrder merges the incoming data from the []int32 into a single stream of []int32,
// merge collects data from all provided channels in turns, each giving a specified time to deliver, else
// skipped until another turn. Once all data is collected from each sender, then the data set is merged into
// a single slice and delivered to the returned channel.
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceMergeInOrder(ctx CancelContext, maxWaitTime time.Duration, senders ...<-chan []int32) <-chan []int32 {
	res := make(chan []int32, 0)
...
// Int32SliceCombineParitallyWithoutOrder receives a giving stream of content from multiple channels, returning a single channel of a
...
// Int32SliceCombineParitallyWithoutOrder makes the following guarantees:
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceCombinePartiallyWithoutOrder(ctx CancelContext, maxItemWait time.Duration, senders ...<-chan []int32) <-chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// Int32SliceCombineWithoutOrder receives a giving stream of content from multiple channels, returning a single channel of a
// 2d slice, it sequentially tries to recieve data from each sender within a provided time duration, else skipping until it's next turn.
// This ensures every sender has adquate time to receive and reducing long blocked waits for a specific sender, more so, this reduces the
// overhead of managing multiple go-routined receving channels which are prone to goroutine ophaning or memory leaks.
// Int32SliceCombineWithoutOrder makes the following guarantees:
// 1. Items will be received in any order received from the channels provided.
// 2. Returned channel will never return incomplete data where a channels return value is missing from its index.
// 3. If any channel is closed then all operation is stopped and the returned channel is closed.
// 4. If the context expires before items are complete then returned channel is closed.
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceCombineWithoutOrder(ctx CancelContext, maxItemWait time.Duration, senders ...<-chan []int32) <-chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// Int32SliceCombineInPartialOrder receives a giving stream of content from multiple channels, returning a single channel of a
// 2d slice, it sequentially tries to recieve data from each sender within a provided time duration, else skipping until it's next turn.
// This ensures every sender has adquate time to receive and reducing long blocked waits for a specific sender, more so, this reduces the
// overhead of managing multiple go-routined receving channels which are prone to goroutine ophaning or memory leaks.
// Int32SliceCombineInPartialOrder makes the following guarantees:
// 1. Items will be received in order and return in order of channels provided.
// 2. Returned channel will never return incomplete data where a channels return value is missing from its index.
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceCombineInPartialOrder(ctx CancelContext, maxItemWait time.Duration, senders ...<-chan []int32) <-chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// Int32SliceCombineInOrder receives a giving stream of content from multiple channels, returning a single channel of a
...
// 7. Will continue to gather data from provided channels until all are closed or the context has expired.
// 8. If any of the senders is nil then the returned channel will be closed, has this leaves things in an unstable state.
func Int32SliceCombineInOrder(ctx CancelContext, maxItemWait time.Duration, senders ...<-chan []int32) <-chan [][]int32 {
	res := make(chan [][]int32, 0)
...
// Int32SliceDistributor delivers messages to subscription channels which it manages internal,
...
type Int32SliceDistributor struct {
	running     int64
	messages    chan []int32
	closer      chan struct{}
...
// NewInt32SliceDistributor returns a new instance of a Int32SliceDistributor.
func NewInt32SliceDistributor(buffer int) *Int32SliceDistributor {
	dist := &Int32SliceDistributor{
...
func (d *Int32SliceDistributor) PublishDeadline(message []int32, dur time.Duration) {
...
func (d *Int32SliceDistributor) Publish(message []int32) {
	if atomic.LoadInt64(&d.running) == 0 {
		return
	}
...
func (d *Int32SliceDistributor) Subscribe(sub chan<- []int32) {
	if atomic.LoadInt64(&d.running) == 0 {
		return
	}
...
func (d *Int32SliceDistributor) Clear() {
	if atomic.LoadInt64(&d.running) == 0 {
		return
	}
...
func (d *Int32SliceDistributor) Stop() {
	if atomic.LoadInt64(&d.running) == 0 {
		return
	}
...
// subscriber adding
func (d *Int32SliceDistributor) manage() {
...
// MonoInt32SliceService defines a interface for underline systems which want to communicate like
...
// @iface
type MonoInt32SliceService interface {
...
// Int32SliceService defines a interface for underline systems which want to communicate like
// in a stream using channels to send/recieve []int32 values. It allows different services to create adapters to
// transform data coming in and out from the Service.
// Auto-Generated using the moz code-generator https://github.com/influx6/moz.
// @iface
type Int32SliceService interface {
	// ReadErrors will return a channel which will allow reading errors from the Service until it it is closed.
	ReadErrors() <-chan error

	// Read will return a channel which will allow reading from the Service until it it is closed.
	Read(string) (<-chan []int32, error)

	// Receive will take the channel, which will be writing into the Service for it's internal processing
	// and the Service will continue to read form the channel till the channel is closed.
	// Useful for collating/collecting services.
	Write(string, <-chan []int32) error
