...
//go:generate moz generate-file -fromFile ./map_slice_service.go -toDir ./impl/mapsliceservice

// MapSliceServiceByteAdapter defines a function that that will take a channel of bytes and return a channel of []map[string]string.
type MapSliceServiceByteAdapter func(chan []byte) chan []map[string]string

// MapSliceServiceToByteAdapter defines a function that that will take a channel of bytes and return a channel of []map[string]string.
type MapSliceServiceToByteAdapter func(chan []map[string]string) chan []byte
